    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="#" class="logo">
          ...
          <span class="logo-mini"><b>Smart Agriculture</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>Smart Agriculture</b></span>
        </a>
  ...
  ?>
             ...
             <!--        <div class="col-xs-4 text-center">
                  ...
                  <li class="user-footer" >
                    <div class="pull-left">
                      <a style="background:#0a0; color:white; border-radius: 50px 50px 50px 50px; outline:none;"  href="<?php echo WEB_ROOT; ?>modules/Users/index.php?view=edit&id=<?php echo $_SESSION['oic_id']; ?>" class="btn btn-default btn-flat"><i class="fa fa-user"></i> View Profile</a>      
                    </div>
                    <div class="pull-right">
                      <a style="background:red; color:white; border-radius: 50px 50px 50px 50px; outline:none;" href="?logout" class="btn btn-default btn-flat"><i class="fa fa-sign-out"></i> Sign out</a> 
                    </div>
                  </li>
                </ul>
              </li>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            <li class="header" style="color:#0a0; font-size:18px;">MAIN NAVIGATION</li>
            ...
            <li id="dashboard">
              <a href="<?php echo WEB_ROOT; ?>index.php">
               ...
               <li class="treeview">
              <a href="modules/sign/index.php">
                <i class="fa fa-bar-chart text-yellow"></i>
                <span>Graph Sensor Value</span>
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo WEB_ROOT; ?>modules/employee/index.php?view=add"><i class="fa fa-plus text-green"></i> Add New Employee</a></li>
                <li><a href="<?php echo WEB_ROOT; ?>modules/employee/index.php"><i class="fa fa-search text-green"></i> View Employee</a></li>
       ...
       <?php if($_SESSION['type']=='Administrator'){?>
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="<?php echo WEB_ROOT; ?>modules/Users/index.php?view=add"><i class="fa fa-plus text-orange"></i> Add New Users</a></li>
              
                <li><a href="<?php echo WEB_ROOT; ?>modules/Users/index.php"><i class="fa fa-search text-orange"></i> View Users List</a></li>
...
/*******************END***********************************************/
      ...
      <footer class="main-footer" id="no">
       ...
       date_default_timezone_set('Asia/Manila');
        ...
        <!-- Default to the left -->
         <strong>Copyright &copy; <?php echo $date; ?> | Agriculture Monitoring System</strong> <b>All rights reserved</b>. 
