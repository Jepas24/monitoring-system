                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
                      <tr style="background:orange;">
                        <th><input type="checkbox" name="chkall" id="chkall" onclick="return checkall('selector[]');"> Emp ID</th>
  ...
  foreach($row as $result) {
              ...
              echo'<td> <div class="info-box">
                ...
                <div class="info-box-content">
                  ...
                  <span id="upr" class="info-box-text">Position: '.$result['emp_position'].'</span>
                  <span id="upr" class="info-box-text">Address: '.$result['address'].'</span>
                  <span id="upr" class="info-box-text">Date Hired: '.$result['datehired'].'</span>
