<?php /*if($_SESSION['type']=='Administrator'){ */?>
        ...
        <section class="content-header">
          <h1>
            Mailing Receipts File 
            <small>Mailing Receipts Panel</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-home"></i> Home</a></li>
            <li class="active">Mailing Receipts Area</li>
          </ol>
        </section>
        <hr>
...
$query = $conn->prepare("SELECT * FROM random");
$query->execute();
$row = $query->fetchall();
...
if($_SESSION['type']=='Administrator'){
  ...
  foreach($row as $result) {
              ...
              echo'<td> <div class="info-box">
                ...
                <div class="info-box-content">
                  ...
                  <span id="upr" class="info-box-text">Project Name: <b>'.$result['projectname'].'</b></span>
                  <span id="upr" class="info-box-text">Cut-off Period: <b>'.$result['cutoff'].'</b></span>
                  <span id="upr" class="info-box-text">Description: <b>'.$result['fdesc'].'</b></span>
                  <span id="upr" class="info-box-text">Date Send: <b>'.$result['fdatein'].'</b></span>  
                  <span id="upr" class="info-box-text">Type: <b>'.$result['type'].'</b></span>
                  <span id="upr" class="info-box-text">Uploaded by: <b>'.$result['fuplder'].'</b></span><br>';
            ...
            echo '<td width="25%"><center> <a id="no" class="btn btn-success" href = "download.php?filename='.$result['imagefile'].'"><i class="fa fa-download"></i> Download</a><a id="no" class="btn btn-danger"  style="color:white;" href = "controller.php?action=delrecord&tid='.$result['id'].'"><i class="fa fa-trash"></i> Delete</a>  </center></td>';
 ...
 foreach($row as $result) {
              ...
              echo'<td> <div class="info-box">
                <!-- Apply any bg-* class to to the icon to color it -->
                <span class="info-box-icon bg-red">
                <img width="100em" height="85em" title="Picture"  src="data:image;base64,'.$result['imagefile'].'" class="user-image" alt="User Image">  </i></span>
                <div class="info-box-content">
