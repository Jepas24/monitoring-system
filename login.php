...
<style>
html {
  background: url(images/picture.png) no-repeat center center fixed; 
...
<!-- Pen Title-->
<div class="pen-title">
  <h1 style="color:white;">Agriculture Monitoring System</h1> 
</div>
...
<div class="container">
  ...
  <div class="card">
    ...
    <form action="#" method="post">
      ...
      <div class="footer" style="color:black; font-size:16px;"><strong><span style="color:red;">Don't have an account?</span><br><justify><span style="color:#0a0;">Please ask the administrator to have an access to <br> Agriculture Monitoring System.</span></justify></strong></div>
    </form>
  </div>
 <!--  <div class="card alt">
